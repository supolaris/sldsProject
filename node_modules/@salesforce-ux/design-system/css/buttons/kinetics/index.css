...
[kx-scope="button"][kx-type="underline"]:after {
  ...
  position: absolute;
  top: calc(
    var(--slds-c-button-spacing-block-start, var(--sds-c-button-spacing-block-start, 0rem)) +
      var(--slds-c-button-line-height, var(--sds-c-button-line-height, 1.875rem)) * 0.8
  );
  height: 0.0625rem;
...
[kx-scope="button-neutral"]:hover {
  ...
  --slds-c-button-color-background-hover: var(
    ...
    var(--sds-c-button-neutral-color-background-hover, var(--slds-g-color-neutral-base-100, white))
  );
  /*! @css-var-fallback border-color */
  --slds-c-button-color-border-hover: var(
    --slds-c-button-neutral-color-border-hover,
    var(--sds-c-button-brand-color-border-hover, #0176d3)
  );
}
[kx-scope="button-neutral"]:active {
  /*! @css-var-fallback background-color */
...
[kx-scope="button-outline"]:focus {
  ...
  --slds-c-button-color-background-hover: var(
    ...
    var(--sds-c-button-outline-brand-color-background-hover, var(--slds-g-color-neutral-base-100, white))
  );
}
[kx-scope="button-outline"]:active {
  /*! @css-var-fallback background-color */
  --slds-c-button-color-background-active: var(
    ...
    var(--sds-c-button-outline-brand-color-background-active, var(--slds-g-color-neutral-base-100, white))
  );
}
