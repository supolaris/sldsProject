// Lightning Design System 2.23.2
// Kinetics vars
...
[kx-scope="button"][kx-type="underline"] {
  ...
  &:after {
    ...
    top: calc(var(--slds-c-button-spacing-block-start, var(--sds-c-button-spacing-block-start, 0rem)) + var(--slds-c-button-line-height, var(--sds-c-button-line-height, #{$line-height-button})) * 0.8); // stylelint-disable length-zero-no-unit
    height: rem(1px);
...
[kx-scope="button-neutral"] {
  ...
  &:hover {
    ...
    --slds-c-button-color-background-hover: var(--slds-c-button-neutral-color-background-hover, var(--sds-c-button-neutral-color-background-hover, var(--slds-g-color-neutral-base-100, #{$button-color-background-primary})));

    /*! @css-var-fallback border-color */
    --slds-c-button-color-border-hover: var(--slds-c-button-neutral-color-border-hover, var(--sds-c-button-brand-color-border-hover, #{$brand-accessible}));
  }

  &:active {
    // These purposefully overrides the interaction states to facilitate the Kinetics effect
    /*! @css-var-fallback background-color */
    --slds-c-button-color-background-active: var(--slds-c-button-neutral-color-background-active, var(--sds-c-button-neutral-color-background-hover, var(--slds-g-color-neutral-base-100, #{$button-color-background-primary})));

    /*! @css-var-fallback border-color */
    --slds-c-button-color-border-active: var(--slds-c-button-neutral-color-border-active, var(--sds-c-button-brand-color-border-hover, #{$brand-accessible}));
  }
}
...
[kx-scope="button-outline"] {
  ...
  &:focus {
    ...
    /*! @css-var-fallback background-color */
    --slds-c-button-color-background-hover: var(--slds-c-button-outline-brand-color-background-hover, var(--sds-c-button-outline-brand-color-background-hover, var(--slds-g-color-neutral-base-100, #{$button-color-background-primary})));
  }

  &:active {
    // This purposefully overrides the interaction states to facilitate the Kinetics effect
    /*! @css-var-fallback background-color */
    --slds-c-button-color-background-active: var(--slds-c-button-outline-brand-color-background-active, var(--sds-c-button-outline-brand-color-background-active, var(--slds-g-color-neutral-base-100, #{$button-color-background-primary})));
  }
}
